...
class Mobile_Detect
{
    ...
    array $headers = null, string $userAgent = null
    )
    {
            ...
            if (isset($this->httpHeaders[$mobileHeader]))
            {
                if (is_array($matchType['matches']))
                {
                    foreach ($matchType['matches'] as $_match)
                        if (strpos($this->httpHeaders[$mobileHeader], $_match))
                            return true;
    ...
    {
        $match = preg_match(sprintf('#%s#is', $regex), (!empty($userAgent) ? $userAgent : $this->userAgent), $matches);
