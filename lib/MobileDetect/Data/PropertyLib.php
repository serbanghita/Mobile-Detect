...
class PropertyLib
{
    ...
    protected static $phoneDevices = array(
        ...
        'HTC'           => array(
            'vendor' => 'HTC',
            'match' => 'HTC|HTC.*(Sensation|Evo|Vision|Explorer|6800|8100|8900|A7272|S510e|C110e|Legend|Desire|T8282)|APX515CKT|Qtek9090|APA9292KT|HD_mini|Sensation.*Z710e|PG86100|Z715e|Desire.*(A8181|HD)|ADR6200|ADR6400L|ADR6425|001HT|Inspire 4G|Android.*\bEVO\b|T-Mobile G1|Z520m',
        ...
        'Nexus'         => array(
            'vendor'     => 'Google',
            'match'      => 'Nexus One|Nexus S|Galaxy.*Nexus|Android.*Nexus.*Mobile|Nexus 4|Nexus 5|Nexus 6',
        ...
        'Motorola'      => array(
            'vendor'     => 'Motorola',
            'match'      => 'Motorola|DROIDX|DROID BIONIC|\bDroid\b.*Build|Android.*Xoom|HRI39|MOT-|A1260|A1680|A555|A853|A855|A953|A955|A956|Motorola.*ELECTRIFY|Motorola.*i1|i867|i940|MB200|MB300|MB501|MB502|MB508|MB511|MB520|MB525|MB526|MB611|MB612|MB632|MB810|MB855|MB860|MB861|MB865|MB870|ME501|ME502|ME511|ME525|ME600|ME632|ME722|ME811|ME860|ME863|ME865|MT620|MT710|MT716|MT720|MT810|MT870|MT917|Motorola.*TITANIUM|WX435|WX445|XT300|XT301|XT311|XT316|XT317|XT319|XT320|XT390|XT502|XT530|XT531|XT532|XT535|XT603|XT610|XT611|XT615|XT681|XT701|XT702|XT711|XT720|XT800|XT806|XT860|XT862|XT875|XT882|XT883|XT894|XT901|XT907|XT909|XT910|XT912|XT928|XT926|XT915|XT919|XT925',
            'modelMatch' => '',
        ),
        ...
        'LG'            => array(
            'vendor'     => 'LG',
            'match'      => '\bLG\b;|LG[- ]?(C800|C900|E400|E610|E900|E-900|F160|F180K|F180L|F180S|730|855|L160|LS740|LS840|LS970|LU6200|MS690|MS695|MS770|MS840|MS870|MS910|P500|P700|P705|VM696|AS680|AS695|AX840|C729|E970|GS505|272|C395|E739BK|E960|L55C|L75C|LS696|LS860|P769BK|P350|P500|P509|P870|UN272|US730|VS840|VS950|LN272|LN510|LS670|LS855|LW690|MN270|MN510|P509|P769|P930|UN200|UN270|UN510|UN610|US670|US740|US760|UX265|UX840|VN271|VN530|VS660|VS700|VS740|VS750|VS910|VS920|VS930|VX9200|VX11000|AX840A|LW770|P506|P925|P999|E612|D955|D802)',
            'modelMatch' => '',
        ),

        'Sony'          => array(
            'vendor'     => 'Sony',
            'match'      => 'SonyST|SonyLT|SonyEricsson|SonyEricssonLT15iv|LT18i|E10i|LT28h|LT26w|SonyEricssonMT27i|C5303|C6902|C6903|C6906|C6943|D2533',
            'modelMatch' => '',
        ),
        ...
        'iMobile'        => array(
            'vendor'    => 'iMobile',
            'match'     => 'i-mobile (IQ|i-STYLE|idea|ZAA|Hitz)',
            'modelMatch' => '',
        ),

        'Wolfgang'       => array(
            'vendor'    => 'Wolfgang',
            'match'     => 'AT-B24D|AT-AS50HD|AT-AS40W|AT-AS55HD|AT-AS45q2|AT-B26D|AT-AS50Q',
            'modelMatch' => '',
        ),
    ...
    protected static $tabletDevices = array(
        ...
        'Kindle'            => array(
            'vendor'     => 'Amazon',
            'match'      => 'Kindle|Silk.*Accelerated|Android.*\b(KFOT|KFTT|KFJWI|KFJWA|KFOTE|KFSOWI|KFTHWI|KFTHWA|KFAPWI|KFAPWA|WFJWAE|KFSAWA|KFSAWI|KFASWI)\b',
        ...
        'SurfaceTablet'     => array(
            'vendor' => 'Microsoft',
            'match' => 'Windows NT [0-9.]+; ARM;.*(Tablet|ARMBJS)',
            'modelMatch' => '',
        ),
        ...
        'HPTablet'          => array(
            'vendor' => 'HP',
            'match' => 'HP Slate (7|8|10)|HP ElitePad 900|hp-tablet|EliteBook.*Touch|HP 8|Slate 21|HP SlateBook 10',
            'modelMatch' => '',
        ),
        ...
        'AsusTablet'        => array(
            'vendor'     => 'Asus',
            'match'      => '^.*PadFone((?!Mobile).)*$|Transformer|TF101|TF101G|TF300T|TF300TG|TF300TL|TF700T|TF700KL|TF701T|TF810C|ME171|ME301T|ME302C|ME371MG|ME370T|ME372MG|ME172V|ME173X|ME400C|Slider SL101|\bK00F\b|\bK00C\b|\bK00E\b|\bK00L\b|TX201LA|ME176C|ME102A|\bM80TA\b|ME372CL|ME560CG|ME372CG',
            'modelMatch' => '',
        ),
        ...
        'HTCtablet'         => array(
            'vendor'     => 'HTC',
            'match'      => 'HTC_Flyer_P512|HTC Flyer|HTC Jetstream|HTC-P715a|HTC EVO View 4G|PG41200|PG09410',
            'modelMatch' => '',
        ),
        ...
        'AcerTablet'        => array(
            'vendor'     => 'Acer',
            'match'      => 'Android.*; \b(A100|A101|A110|A200|A210|A211|A500|A501|A510|A511|A700|A701|W500|W500P|W501|W501P|W510|W511|W700|G100|G100W|B1-A71|B1-710|B1-711|A1-810|A1-811|A1-830)\b|W3-810|\bA3-A10\b',
            'modelMatch' => '',
        ),
        ...
        'LGTablet'          => array(
            'vendor'     => 'LG',
            'match'      => '\bL-06C|LG-V909|LG-V900|LG-V700|LG-V510|LG-V500|LG-V410|LG-V400|LG-VK810\b',
            'modelMatch' => '',
        ),

        'FujitsuTablet'     => array(
            'vendor' => 'Fujitsu',
            'match' => 'Android.*\b(F-01D|F-02F|F-05E|F-10D|M532|Q572)\b',
            'modelMatch' => '',
        ),
        ...
        'LenovoTablet'      => array(
            'vendor'     => 'Lenovo',
            'match'      => 'Idea(Tab|Pad)( A1|A10| K1|)|ThinkPad([ ]+)?Tablet|Lenovo.*(S2109|S2110|S5000|S6000|K3011|A3000|A3500|A1000|A2107|A2109|A1107|A5500|A7600|B6000|B8000|B8080)(-|)(FL|F|HV|H|)',
            'modelMatch' => '',
        ),
        ...
        'YarvikTablet'      => array(
            'vendor'     => 'Yarvik',
            'match'      => 'Android.*\b(TAB210|TAB211|TAB224|TAB250|TAB260|TAB264|TAB310|TAB360|TAB364|TAB410|TAB411|TAB420|TAB424|TAB450|TAB460|TAB461|TAB464|TAB465|TAB467|TAB468|TAB07-100|TAB07-101|TAB07-150|TAB07-151|TAB07-152|TAB07-200|TAB07-201-3G|TAB07-210|TAB07-211|TAB07-212|TAB07-214|TAB07-220|TAB07-400|TAB07-485|TAB08-150|TAB08-200|TAB08-201-3G|TAB08-201-30|TAB09-100|TAB09-211|TAB09-410|TAB10-150|TAB10-201|TAB10-211|TAB10-400|TAB10-410|TAB13-201|TAB274EUK|TAB275EUK|TAB374EUK|TAB462EUK|TAB474EUK|TAB9-200)\b',
            'modelMatch' => '',
        ),
        ...
        'ArnovaTablet'      => array(
            'vendor' => 'Arnova',
            'match' => 'AN10G2|AN7bG3|AN7fG3|AN8G3|AN8cG3|AN7G3|AN9G3|AN7dG3|AN7dG3ST|AN7dG3ChildPad|AN10bG3|AN10bG3DT|AN9G2',
            'modelMatch' => '',
        ),
        ...
        'ArchosTablet'      => array(
            'vendor' => 'Archos',
            'match' => '\b(101G9|80G9|A101IT)\b|Qilive 97R|Archos5|\bARCHOS (70|79|80|90|97|101|FAMILYPAD|)(b|)(G10| Cobalt| TITANIUM(HD|)| Xenon| Neon|XSK| 2| XS 2| PLATINUM| CARBON|GAMEPAD)\b',
            'modelMatch' => '',
        ),
        ...
        'SonyTablet'        => array(
            'vendor' => 'Sony',
            'match' => 'Sony.*Tablet|Xperia Tablet|Sony Tablet S|SO-03E|SGPT12|SGPT13|SGPT114|SGPT121|SGPT122|SGPT123|SGPT111|SGPT112|SGPT113|SGPT131|SGPT132|SGPT133|SGPT211|SGPT212|SGPT213|SGP311|SGP312|SGP321|EBRD1101|EBRD1102|EBRD1201|SGP351|SGP341|SGP511|SGP512|SGP521|SGP541|SGP551',
            'modelMatch' => '',
        ),
        ...
        'HuaweiTablet'      => array(
            'vendor'     => 'Huawei',
            'match'      => 'MediaPad|MediaPad 7 Youth|IDEOS S7|S7-201c|S7-202u|S7-101|S7-103|S7-104|S7-105|S7-106|S7-201|S7-Slim',
            'modelMatch' => '',
        ),
        ...
        'GUTablet'          => array(
            'vendor'     => 'GU',
            'match'      => 'TX-A1301|TX-M9002|Q702|kf026',
            'modelMatch' => '',
        ...
        'DellTablet' => array(
            'vendor' => 'DellTablet',
            'match' => 'Venue 11|Venue 8|Venue 7|Dell Streak 10|Dell Streak 7',
            'modelMatch' => '',
        ),
        'IntensoTablet' => array(
            'vendor' => 'IntensoTablet',
            'match' => 'INM8002KP|INM1010FP|INM805ND|Intenso Tab|TAB1004',
            'modelMatch' => '',
        ),
        'PhilipsTablet' => array(
            'vendor' => 'PhilipsTablet',
            'match' => '\b(PI2010|PI3000|PI3100|PI3105|PI3110|PI3205|PI3210|PI3900|PI4010|PI7000|PI7100)\b',
            'modelMatch' => '',
        ),
        'MSITablet' => array(
            'vendor' => 'MSITablet',
            'match' => 'MSI \b(Primo 73K|Primo 73L|Primo 81L|Primo 77|Primo 93|Primo 75|Primo 76|Primo 73|Primo 81|Primo 91|Primo 90|Enjoy 71|Enjoy 7|Enjoy 10)\b',
            'modelMatch' => '',
        ),
        'TrekstorTablet' => array(
            'vendor' => 'TrekstorTablet',
            'match' => 'ST10416-1|VT10416-1|ST70408-1|ST702xx-1|ST702xx-2|ST80208|ST97216|ST70104-2|VT10416-2|ST10216-2A|SurfTab',
            'modelMatch' => '',
        ),
        'PyleAudioTablet' => array(
            'vendor' => 'PyleAudioTablet',
            'match' => '\b(PTBL10CEU|PTBL10C|PTBL72BC|PTBL72BCEU|PTBL7CEU|PTBL7C|PTBL92BC|PTBL92BCEU|PTBL9CEU|PTBL9CUK|PTBL9C)\b',
            'modelMatch' => '',
        ),
        'AdvanTablet' => array(
            'vendor' => 'AdvanTablet',
            'match' => 'Android.* \b(E3A|T3X|T5C|T5B|T3E|T3C|T3B|T1J|T1F|T2A|T1H|T1i|E1C|T1-E|T5-A|T4|E1-B|T2Ci|T1-B|T1-D|O1-A|E1-A|T1-A|T3A|T4i)\b ',
            'modelMatch' => '',
        ),
        'DanyTechTablet' => array(
            'vendor' => 'DanyTechTablet',
            'match' => 'Genius Tab G3|Genius Tab S2|Genius Tab Q3|Genius Tab G4|Genius Tab Q4|Genius Tab G-II|Genius TAB GII|Genius TAB GIII|Genius Tab S1',
            'modelMatch' => '',
        ),
        'VoninoTablet' => array(
            'vendor' => 'VoninoTablet',
            'match' => '\b(Argus[ _]?S|Diamond[ _]?79HD|Emerald[ _]?78E|Luna[ _]?70C|Onyx[ _]?S|Onyx[ _]?Z|Orin[ _]?HD|Orin[ _]?S|Otis[ _]?S|SpeedStar[ _]?S|Magnet[ _]?M9|Primus[ _]?94[ _]?3G|Primus[ _]?94HD|Primus[ _]?QS|Android.*\bQ8\b|Sirius[ _]?EVO[ _]?QS|Sirius[ _]?QS|Spirit[ _]?S)\b',
            'modelMatch' => '',
        ),
        'ECSTablet' => array(
            'vendor' => 'ECSTablet',
            'match' => 'V07OT2|TM105A|S10OT1|TR10CS1',
            'modelMatch' => '',
        ),
        'StorexTablet' => array(
            'vendor' => 'StorexTablet',
            'match' => 'eZee[_\']?(Tab|Go)[0-9]+|TabLC7|Looney Tunes Tab',
            'modelMatch' => '',
        ),
        'VodafoneTablet' => array(
            'vendor' => 'VodafoneTablet',
            'match' => 'SmartTab([ ]+)?[0-9]+|SmartTabII10|SmartTabII7',
            'modelMatch' => '',
        ),
        'EssentielBTablet' => array(
            'vendor' => 'EssentielBTablet',
            'match' => 'Smart[ \']?TAB[ ]+?[0-9]+|Family[ \']?TAB2',
            'modelMatch' => '',
        ),
        'RossMoorTablet' => array(
            'vendor' => 'RossMoorTablet',
            'match' => 'RM-790|RM-997|RMD-878G|RMD-974R|RMT-705A|RMT-701|RME-601|RMT-501|RMT-711',
            'modelMatch' => '',
        ),
        'iMobileTablet' => array(
            'vendor' => 'iMobileTablet',
            'match' => 'i-mobile i-note',
            'modelMatch' => '',
        ),
        'TolinoTablet' => array(
            'vendor' => 'TolinoTablet',
            'match' => 'tolino tab [0-9.]+|tolino shine',
            'modelMatch' => '',
        ),
        'AudioSonicTablet' => array(
            'vendor' => 'AudioSonicTablet',
            'match' => '\bC-22Q|T7-QC|T-17B|T-17P\b',
            'modelMatch' => '',
        ),
        'AMPETablet' => array(
            'vendor' => 'AMPETablet',
        ...
        'SkkTablet' => array(
            'vendor' => 'SkkTablet',
            'match' => 'Android.* (SKYPAD|PHOENIX|CYCLOPS)',
            'modelMatch' => '',
        ),
        'TecnoTablet' => array(
            'vendor' => 'TecnoTablet',
        ...
        'JXDTablet' => array(
            'vendor' => 'JXDTablet',
            'match' => 'Android.*\b(F3000|A3300|JXD5000|JXD3000|JXD2000|JXD300B|JXD300|S5800|S7800|S602b|S5110b|S7300|S5300|S602|S603|S5100|S5110|S601|S7100a|P3000F|P3000s|P101|P200s|P1000m|P200m|P9100|P1000s|S6600b|S908|P1000|P300|S18|S6600|S9100)\b',
            'modelMatch' => '',
        ),
        'iJoyTablet' => array(
            'vendor' => 'iJoyTablet',
            'match' => 'Tablet (Spirit 7|Essentia|Galatea|Fusion|Onix 7|Landa|Titan|Scooby|Deox|Stella|Themis|Argon|Unique 7|Sygnus|Hexen|Finity 7|Cream|Cream X2|Jade|Neon 7|Neron 7|Kandy|Scape|Saphyr 7|Rebel|Biox|Rebel|Rebel 8GB|Myst|Draco 7|Myst|Tab7-004|Myst|Tadeo Jones|Tablet Boing|Arrow|Draco Dual Cam|Aurix|Mint|Amity|Revolution|Finity 9|Neon 9|T9w|Amity 4GB Dual Cam|Stone 4GB|Stone 8GB|Andromeda|Silken|X2|Andromeda II|Halley|Flame|Saphyr 9,7|Touch 8|Planet|Triton|Unique 10|Hexen 10|Memphis 4GB|Memphis 8GB|Onix 10)',
            'modelMatch' => '',
        ),
        'FX2Tablet' => array(
            'vendor' => 'FX2Tablet',
            'match' => 'FX2 PAD7|FX2 PAD10',
            'modelMatch' => '',
        ),
        'XoroTablet' => array(
            'vendor' => 'XoroTablet',
            'match' => 'KidsPAD 701|PAD[ ]?712|PAD[ ]?714|PAD[ ]?716|PAD[ ]?717|PAD[ ]?718|PAD[ ]?720|PAD[ ]?721|PAD[ ]?722|PAD[ ]?790|PAD[ ]?792|PAD[ ]?900|PAD[ ]?9715D|PAD[ ]?9716DR|PAD[ ]?9718DR|PAD[ ]?9719QR|PAD[ ]?9720QR|TelePAD1030|Telepad1032|TelePAD730|TelePAD731|TelePAD732|TelePAD735Q|TelePAD830|TelePAD9730|TelePAD795|MegaPAD 1331|MegaPAD 1851|MegaPAD 2151',
            'modelMatch' => '',
        ),
        'ViewsonicTablet' => array(
            'vendor' => 'ViewsonicTablet',
            'match' => 'ViewPad 10pi|ViewPad 10e|ViewPad 10s|ViewPad E72|ViewPad7|ViewPad E100|ViewPad 7e|ViewSonic VB733|VB100a',
            'modelMatch' => '',
        ),
        'OdysTablet' => array(
            'vendor' => 'OdysTablet',
            'match' => 'LOOX|XENO10|ODYS[ -](Space|EVO|Xpress|NOON)|\bXELIO\b|Xelio10Pro|XELIO7PHONETAB|XELIO10EXTREME|XELIOPT2|NEO_QUAD10',
            'modelMatch' => '',
        ),
        'CaptivaTablet' => array(
            'vendor' => 'CaptivaTablet',
            'match' => 'CAPTIVA PAD',
            'modelMatch' => '',
        ),
        'IconbitTablet' => array(
            'vendor' => 'IconbitTablet',
            'match' => 'NetTAB|NT-3702|NT-3702S|NT-3702S|NT-3603P|NT-3603P|NT-0704S|NT-0704S|NT-3805C|NT-3805C|NT-0806C|NT-0806C|NT-0909T|NT-0909T|NT-0907S|NT-0907S|NT-0902S|NT-0902S',
            'modelMatch' => '',
        ),
        'TeclastTablet' => array(
            'vendor' => 'TeclastTablet',
            'match' => 'T98 4G|\bP80\b|\bX90HD\b|X98 Air|X98 Air 3G|\bX89\b|P80 3G|\bX80h\b|P98 Air|\bX89HD\b|P98 3G|\bP90HD\b|P89 3G|X98 3G|\bP70h\b|P79HD 3G|G18d 3G|\bP79HD\b|\bP89s\b|\bA88\b|\bP10HD\b|\bP19HD\b|G18 3G|\bP78HD\b|\bA78\b|\bP75\b|G17s 3G|G17h 3G|\bP85t\b|\bP90\b|\bP11\b|\bP98t\b|\bP98HD\b|\bG18d\b|\bP85s\b|\bP11HD\b|\bP88s\b|\bA80HD\b|\bA80se\b|\bA10h\b|\bP89\b|\bP78s\b|\bG18\b|\bP85\b|\bA70h\b|\bA70\b|\bG17\b|\bP18\b|\bA80s\b|\bA11s\b|\bP88HD\b|\bA80h\b|\bP76s\b|\bP76h\b|\bP98\b|\bA10HD\b|\bP78\b|\bP88\b|\bA11\b|\bA10t\b|\bP76a\b|\bP76t\b|\bP76e\b|\bP85HD\b|\bP85a\b|\bP86\b|\bP75HD\b|\bP76v\b|\bA12\b|\bP75a\b|\bA15\b|\bP76Ti\b|\bP81HD\b|\bA10\b|\bT760VE\b|\bT720HD\b|\bP76\b|\bP73\b|\bP71\b|\bP72\b|\bT720SE\b|\bC520Ti\b|\bT760\b|\bT720VE\b|T720-3GE|T720-WiFi',
            'modelMatch' => '',
        ),
        'JaytechTablet' => array(
            'vendor' => 'JaytechTablet',
            'match' => 'TPC-PA762',
            'modelMatch' => '',
        ),
        'BlaupunktTablet' => array(
            'vendor' => 'BlaupunktTablet',
            'match' => 'Endeavour 800NG|Endeavour 1010',
            'modelMatch' => '',
        ),
        'DigmaTablet' => array(
            'vendor' => 'DigmaTablet',
            'match' => '\b(iDx10|iDx9|iDx8|iDx7|iDxD7|iDxD8|iDsQ8|iDsQ7|iDsQ8|iDsD10|iDnD7|3TS804H|iDsQ11|iDj7|iDs10)\b',
            'modelMatch' => '',
        ),
        'EvolioTablet' => array(
            'vendor' => 'EvolioTablet',
            'match' => 'ARIA_Mini_wifi|Aria[ _]Mini|Evolio X10|Evolio X7|Evolio X8|\bEvotab\b|\bNeura\b',
            'modelMatch' => '',
        ),
        'LavaTablet' => array(
            'vendor' => 'LavaTablet',
            'match' => 'QPAD E704|\bIvoryS\b|E-TAB IVORY',
            'modelMatch' => '',
        ),
        'CelkonTablet' => array(
            'vendor' => 'CelkonTablet',
            'match' => 'CT695|CT888|CT[\s]?910|CT7 Tab|CT9 Tab|CT3 Tab|CT2 Tab|CT1 Tab|C820|C720|\bCT-1\b',
            'modelMatch' => '',
        ),
        'MiTablet' => array(
            'vendor' => 'MiTablet',
            'match' => '\bMI PAD\b|\bHM NOTE 1W\b',
            'modelMatch' => '',
        ),
        'NibiruTablet' => array(
            'vendor' => 'NibiruTablet',
            'match' => 'Nibiru M1|Nibiru Jupiter One',
            'modelMatch' => '',
        ),
        'NexoTablet' => array(
            'vendor' => 'NexoTablet',
            'match' => 'NEXO NOVA|NEXO 10|NEXO AVIO|NEXO FREE|NEXO GO|NEXO EVO|NEXO 3G|NEXO SMART|NEXO KIDDO|NEXO MOBI',
            'modelMatch' => '',
        ),
        'UbislateTablet' => array(
            'vendor' => 'UbislateTablet',
            'match' => 'UbiSlate[\s]?7C',
            'modelMatch' => '',
        ),
        'PocketBookTablet' => array(
            'vendor' => 'PocketBookTablet',
            'match' => 'Pocketbook',
            'modelMatch' => '',
        ),
        ...
        'GenericTablet'     => array(
            ...
            'match' => 'Android.*\b97D\b|Tablet(?!.*PC)|BNTV250A|MID-WCDMA|LogicPD Zoom2|\bA7EB\b|CatNova8|A1_07|CT704|CT1002|\bM721\b|rk30sdk|\bEVOTAB\b|M758A|ET904|ALUMIUM10|Smartfren Tab|Endeavour 1010|Tablet-PC-4|Tagi Tab|\bM6pro\b|CT1020W|arc 10HD|\bJolla\b',
            'modelMatch' => false,
        ),
    );
