...
class BasicTest extends PHPUnit_Framework_TestCase
{
    ...
    /*
    * test function checkHttpHeadersForMobile
    */
    public function testCheckHttpHeadersForMobile()
    {
        $this->assertNotEmpty( $this->detect->getScriptVersion() );
        ...
        $this->detect->setHttpHeaders(array(
                ...
                'REMOTE_ADDR'           => '11.22.33.44',
                'REQUEST_TIME'          => '01-10-2012 07:57',
                'HTTP_UA_CPU'           => 'ARM'  //this is the mobileHeaders's last key, when line 93 run true, it runs good
            ));
